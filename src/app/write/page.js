...
const WritePage = () => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      {showInputModal && (
        <Modal isOpen={showInputModal} closeModal={closeModal}>
          <div className={modalStyle.modalArticle}>
            <h2>Article is almost ready</h2>
            <p>Add a title and subtitle </p>
            ...
            <div className={modalStyle.bottom}>
              <button className={styles.button} onClick={handleInputModalSubmit}>Publish</button>
            </div>
          </div>
        </Modal>
      )}
      {showSuccessModal && (
        <Modal isOpen={showSuccessModal} closeModal={closeModal}>
      ...
      {showWalletModal && (
        ...
        <Modal isOpen={showWalletModal} closeModal={closeModal}>
          <div className={modalStyle.modalContent}>
